...
7. The console displays the current time and the alarm time (System time starts at 10 seconds to midnight and gets updated every one second)

    ![output](images/output_rtc_alarm_1.png)

8. Once the system Time reaches 10 seconds after midnight , the following message is displayed and RGB_LED toggles between green and blue color
