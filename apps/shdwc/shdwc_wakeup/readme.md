...
Application starts by toggling the LED, indicating that the device is up and running. Upon pressing the switch, it goes to shutdown mode (stops toggling the LED). Upon pulling the START_PMIC pin to high, the device is reboot and the LED starts toggling again.
...
Path of the application within the repository is **apps/shdwc/shdwc_wakeup/firmware** .
