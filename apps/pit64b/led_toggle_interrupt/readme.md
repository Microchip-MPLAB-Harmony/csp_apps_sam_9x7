...
This application toggles an LED based off the PIT64B0 interrupt. Every time the PIT64B0 counter expires the LED toggles.
...
2. LED toggles every 500 milliseconds
